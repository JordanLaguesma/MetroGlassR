<?php if ((current_url() !== site_url('customer/cart') && current_url() !== site_url('customer/checkout')) && session()->get('logged_in') === TRUE) : ?>
    <div class="navbar-cart">
        <a class="icon-btn primary-icon-text icon-text-btn" href="javascript:void(0)">
            ...
            <span id="cart_items_mobile" class="icon-text text-style-1"></span>
        </a>
        <div class="navbar-cart-dropdown">
            <div class="checkout-style-2">
                ...
                <div class="checkout-table table-responsive" style="overflow-y: auto; max-height: 300px;">
                    <table id="table_cart_tab_mobile" class="table">
