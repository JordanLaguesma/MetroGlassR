                        ...
                        <div class="product-details-image mt-50">
                            <div class="product-image">
                                <div class="product-image-active-1">
                                    ...
                                    <!-- <div class="single-image">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/product-2.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="single-image">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/product-3.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="single-image">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/product-4.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="single-image">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/product-5.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="single-image">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/product-3.jpg'); ?>" alt="" />
                                    </div> -->
                            ...
                            <!-- <div class="product-thumb-image">
                                <div class="product-thumb-image-active-1">
                                    <div class="single-thumb">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/thunb-1.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="single-thumb">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/thunb-2.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="single-thumb">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/thunb-3.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="single-thumb">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/thunb-4.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="single-thumb">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/thunb-5.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="single-thumb">
                                        <img src="<?= base_url('customer/assets/images/product-details-1/thunb-3.jpg'); ?>" alt="" />
                                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content mt-45">
                                ...
                                <div class="items-wrapper">
                                    <div class="single-item active">
                                        <div class="items-image">
                                            <img src="<?= base_url('customer/assets/images/product-details-1/product-items-1.jpg'); ?>" alt="product" />
                                        </div>
                            ...
                            <div class="product-btn">
                                <a href="javascript:void(0)" class="main-btn primary-btn add_to_cart" data-id="<?= $product['id']; ?>" data-image="<?= $product['image']; ?>" data-name="<?= $product['name'] ?>" data-type="<?= $product['type']; ?>" data-size="<?= $product['size']; ?>" data-price="<?= $product['price']; ?>">
                                    <img src="<?= base_url('customer/assets/images/icon-svg/cart-4.svg'); ?>" alt="" />
                                    Add to cart
                                </a>
                                <a href="checkout?id=<?= $product['id']; ?>" class="main-btn secondary-1-btn">
                                    <img src="<?= base_url('customer/assets/images/icon-svg/cart-8.svg'); ?>" alt="" />
                                    Buy Now
                                </a>
                            </div>
                        </div>
                                    ...
                                    <?php for ($i = 5; $i > 0; $i--) : ?>
                                        <div class="reviews-rating-bar">
                                            <div class="single-reviews-rating-bar">
                                                <p class="value"><?php echo $i; ?> Star<?php if($i > 1) echo 's'; ?></p>
                                ...
                                <div class="reviews-rating-form">
                                    <div class="rating-star">
                                        ...
                                        <ul id="stars" class="stars">
                                            <?php for ($i = 0; $i < 5; $i++) : ?>
                                                <li class="star" data-value="<?php echo ($i + 1); ?>">
                                ...
                                <div class="reviews-btn-left">
                                    <div class="dropdown-style">
                                        <div class="dropdown dropdown-white">
                                            <button class="main-btn primary-btn" type="button" id="dropdownMenu-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                    ...
                                    <div class="dropdown-style">
                                        <div class="dropdown dropdown-white">
                                            <button class="main-btn primary-btn-border" type="button" id="dropdownMenu-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                ...
                                <ul class="comment-items">
                                        ...
                                        <div class="single-review-comment">
                                            <div class="comment-user-info">
                                                <div class="comment-author">
                                                    <img src="<?= base_url('customer/assets/images/review/author-1.jpg'); ?>" alt="" />
                                                </div>
                                        ...
                                        <ul class="comment-replay">
                                            <li>
                                                <div class="single-review-comment">
                                                    <div class="comment-user-info">
                                                        <div class="comment-author">
                                                            <img src="<?= base_url('customer/assets/images/review/author-2.jpg'); ?>" alt="" />
                                                        </div>
                                                        <div class="comment-content">
                                                            <h6 class="name">User Name</h6>
                                                    ...
                                                    <div class="comment-user-text">
                                                        ...
                                                        <div class="comment-image flex-wrap">
                                                            <div class="image">
                                                                <img src="<?= base_url('customer/assets/images/review/attachment-1.jpg'); ?>" alt="" />
                                                            </div>
                                                            <div class="image">
                                                                <img src="<?= base_url('customer/assets/images/review/attachment-2.jpg'); ?>" alt="" />
                                                            </div>
                                                        </div>
                                                        <ul class="comment-meta">
                                                            <li>
                                            ...
                                            <li>
                                                <div class="single-review-comment">
                                                    <div class="comment-user-info">
                                                        <div class="comment-author">
                                                            <img src="<?= base_url('customer/assets/images/review/author-3.jpg'); ?>" alt="" />
                                                        </div>
                                                        <div class="comment-content">
                                                            <h6 class="name">User Name</h6>
                                    ...
                                    <li>
                                        <div class="single-review-comment">
                                            <div class="comment-user-info">
                                                <div class="comment-author">
                                                    <img src="<?= base_url('customer/assets/images/review/author-4.jpg'); ?>" alt="" />
                                                </div>
                                                <div class="comment-content">
                                                    <h6 class="name">User Name</h6>
