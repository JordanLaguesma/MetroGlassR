                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="preview-list">
                        ...
                        ?>
                          <div class="preview-item <?php $key === $total_results - 1 ? '' : 'border-bottom' ?>">
                            ...
                            <div class="preview-item-content d-sm-flex flex-grow">
                              <div class="flex-grow">
                                <h6 class="preview-subject"><?= esc($result->firstname) . ' ' . esc($result->lastname); ?></h6>
                                <p class="text-muted mb-0"><?= esc($result->product_name); ?></p>
                              </div>
                              <div class="me-auto text-sm-right pt-2 pt-sm-0">
                                <a class="btn btn-outline-success" href="orders">Review</a>
                                <p class="text-muted mb-0 pt-2">₱<?= esc($result->order_subtotal); ?></p>
                              </div>
                            </div>
                          </div>
                        <?php endforeach; ?>
...
<!-- Backend -->
<?= $this->include('backend/cashier/change_password.php'); ?>
<!-- End Backend -->
